...
    entrada_usuario = "Me ajude com o meu projeto."
    
...
        break
    
    # Verifica se a entrada do usuário contém alguma palavra ofensiva
...
        response = modelo.generate_content(entrada_usuario)
        print(f"{NOME_PENSABOT}: {response.text}")
